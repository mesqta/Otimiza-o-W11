...
echo Decreasing processes kill time and menu show delay...
...
echo Disable Popups, baloon tips etc...
...
echo Finalizando ajustes, aguarde...
timeout /t 5 >nul

echo Execução do script concluída. Reiniciando o sistema...
shutdown /r /t 5
